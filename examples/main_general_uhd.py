...
# Generated: Mon Jan 20 19:41:17 2020
##################################################
...
class main_general_uhd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=64, N=1, T_bch=200, T_g=20, T_p=200, T_s=150, bs_slots=range(10), control='random', cp_ratio=0.25, frame_size=12000, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0), modulation=4, puncpat='11'):
        ...
        self.ephyl_data_and_access_control_0 = ephyl.data_and_access_control(bs_slots,control,1)
