...
# Title: Main General
# Generated: Sat Jan 18 09:58:31 2020
##################################################
...
class main_general(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=64, N=1, T_bch=50, T_g=40, T_p=200, T_s=100, bs_slots=range(6), control='random', cp_ratio=0.25, frame_size=12000, hdr_format=digital.header_format_default(digital.packet_utils.default_access_code, 0), modulation=4, puncpat='11'):
        ...
        self.ephyl_data_and_access_control_0 = ephyl.data_and_access_control(bs_slots,control,.5)
        ...
        self.connect((self.blocks_char_to_float_1_1, 0), (self.qtgui_time_sink_x_1, 0))
        ...
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_char_to_float_1_1, 0))
        ...
        self.connect((self.fec_extended_tagged_decoder_1, 0), (self.blocks_char_to_float_1_0, 0))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--control", dest="control", type="string", default='random',
