...
# Title: Demo Loop
# Generated: Sat Jan 18 15:53:26 2020
##################################################
...
class demo_loop(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=32, N=1, T_bch=50, T_g=20, T_p=100, T_s=50, T_sync=50, bs_slots=range(8), control0='all', control1='ucb', control2='basic', control3='ucb', cp_ratio=0.25):
        ...
        self.bs_slots_0 = bs_slots_0 = bs_slots[:-4]
    ...
    def set_bs_slots(self, bs_slots):
        self.bs_slots = bs_slots
        self.set_frame_len((self.T_bch+self.T_sync+len(self.bs_slots)*(self.T_s+self.T_g)+self.T_p)/float(1000))
        self.set_bs_slots_0(self.bs_slots[:-4])
    ...
    def set_bs_slots_0(self, bs_slots_0):
        ...
        self.hier_sensor_0.set_bs_slots(self.bs_slots_0)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--control1", dest="control1", type="string", default='ucb',
        help="Set Control [default=%default]")
    parser.add_option(
