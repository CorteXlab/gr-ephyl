...
# Title: Main Turbo
# Generated: Sat Jan 18 09:54:31 2020
##################################################
...
class main_turbo(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=64, N=1, T_bch=50, T_g=20, T_p=100, T_s=50, bs_slots=range(1), control='none', cp_ratio=0.25, modulation=4):
        ...
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0_0_0_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_TAG, qtgui.TRIG_SLOPE_POS, 0.1, 0, 0, 'BCH')
        ...
        self.connect((self.ephyl_bs_scheduler_0, 0), (self.qtgui_time_sink_x_0_0_0_1_0_0_0_0_0_0_0_0_0, 0))
