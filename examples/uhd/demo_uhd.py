...
# Title: Demo Uhd
# Generated: Fri Jan 24 16:51:41 2020
##################################################
...
class demo_uhd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, M=64, N=1, T_bch=200, T_g=20, T_p=200, T_s=150, bs_slots=range(10), control0='all', control1='8:9', control2='basic', control3='ucb', cp_ratio=0.25):
        ...
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_0_3, 'BCN'))
        self.msg_connect((self.blocks_socket_pdu_0_0, 'pdus'), (self.hier_sensor_0_3, 'DL'))
        ...
        self.connect((self.hier_sensor_0_3, 1), (self.uhd_usrp_sink_0, 0))
    ...
    def set_control0(self, control0):
        self.control0 = control0
        self.hier_sensor_0_3.set_control(self.control0)
