...
# Generated: Fri Jan 31 17:10:15 2020
##################################################
...
class ms_fixed_var_activ_0to3(gr.top_block):
    ...
    def __init__(self, M=32, N=1, T_bch=200, T_g=50, T_p=2000, T_s=150, ar0=0.1, ar1=0.2, ar2=0.3, ar3=0.4, bs_slots=range(10), control0='0', control1='1', control2='2', control3='3', cp_ratio=0.25):
